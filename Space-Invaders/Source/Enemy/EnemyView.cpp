...
namespace Enemy
{
	...
	void EnemyView::initialize(EnemyController* controller)
	{
		enemy_controller = controller;
		 game_window = game_window = ServiceLocator::getInstance()->getGraphicService()->getGameWindow();
	...
	void EnemyView::scaleEnemySprite()
	{
		enemy_sprite.setScale(
			...
			static_cast<float>(enemy_sprite_width) / enemy_sprite.getTexture()->getSize().y
		);
	}
